object frmDetalheOferta: TfrmDetalheOferta
  Left = 0
  Top = 0
  ...
  object cxGridOfertasCadastradas: TcxGrid
    ...
    object tblItensOferta: TcxGridDBTableView
      Navigator.Buttons.CustomButtons = <>
      DataController.DataSource = DMOfertas.dsOfertasCadastradasItem
      DataController.DetailKeyFieldNames = 'CODOFERTA'
      DataController.KeyFieldNames = 'CODOFERTA'
      ...
      object tblItensOfertaMOTIVOOFERTA: TcxGridDBColumn
        Caption = 'Motivo'
