object frmAplicarPreco: TfrmAplicarPreco
  Left = 0
  Top = 0
  BorderStyle = bsSingle
  Caption = 'Aplicar pre'#231'o'
  ClientHeight = 274
  ClientWidth = 619
  Color = clBtnFace
  ...
  object cxBox: TcxGroupBox
    ...
    Height = 274
    Width = 619
    object pbStatusAplicacao: TcxProgressBar
      Left = 58
      Top = 191
    ...
    object gbVariacaoPreco: TcxGroupBox
      Left = 58
      Top = 40
      Enabled = False
      TabOrder = 3
      ...
      Height = 122
      Width = 479
      object cbVariacaoPreco: TcxCheckBox
        Left = 136
        Top = 3
        Caption = 'Aplicar Varia'#231#227'o de Pre'#231'o'
        TabOrder = 0
        Transparent = True
        OnClick = cbVariacaoPrecoClick
      end
      object edtPorcentagem: TcxCurrencyEdit
        ...
        Properties.OnChange = edtPorcentagemPropertiesChange
        TabOrder = 1
        Width = 121
      end
      ...
      object cbAplicarArredondamento: TcxCheckBox
        Left = 65
        Top = 92
        Caption = 'Aplicar arredondamento sobre o valor total'
        TabOrder = 6
        Transparent = True
      end
    end
    object lblStatus: TcxLabel
      ...
      Top = 165
      AutoSize = False
      Caption = 'Status da aplica'#231#227'o'
      ParentFont = False
      Style.Font.Charset = DEFAULT_CHARSET
      Style.Font.Color = clWindowText
