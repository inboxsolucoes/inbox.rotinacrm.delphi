object frmPrecificacaoCluster: TfrmPrecificacaoCluster
  Left = 0
  Top = 0
  Caption = 'M'#243'dulo de Precifica'#231#227'o Cluster'
  ClientHeight = 624
  ClientWidth = 1033
  Color = clBtnFace
  ...
  object pnl1: TPanel
    ...
    object labelProdutosSemComprador: TcxLabel
      Left = 214
      Top = 84
      Anchors = [akLeft]
      AutoSize = False
      Caption = 'Existem produtos sem comprador definido na rotina 238!'
      ParentColor = False
      ParentFont = False
  ...
  object cxgPrecificacao: TcxGrid
    ...
    object tblEmbalagensAbas: TcxGridDBBandedTableView
      ...
      DataController.DataSource = DMPrecificacao.dsEmbCluster
